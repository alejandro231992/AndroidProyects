...
import upc.smtpra.perfeet.databinding.ItemReviewBinding
import upc.smtpra.perfeet.models.ProductDataNew
import upc.smtpra.perfeet.models.ProductReviewData
...
class ReviewsActivity : AppBaseActivity() {
    private lateinit var mProductModels: ProductDataNew
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mProductModels = intent.getSerializableExtra(Constants.KeyIntent.DATA) as ProductDataNew
    ...
    private fun createProductReview() {
        ...
        dialog.btnSubmit.onClick {
            ...
            requestModel.product_id = mProductModels.pro_id.toString()
