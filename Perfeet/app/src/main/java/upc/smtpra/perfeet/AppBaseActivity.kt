...
import upc.smtpra.perfeet.utils.Constants.THEME.DARK
import upc.smtpra.perfeet.utils.extensions.changeToolbarFont
...
import upc.smtpra.perfeet.utils.extensions.switchToDarkMode
import java.util.*
...
open class AppBaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        switchToDarkMode(PerFeetApp.appTheme == DARK)
        ...
        themeApp = PerFeetApp.appTheme
        language = Locale(PerFeetApp.language)
    }
    ...
    private fun updateBaseContextLocale(context: Context): Context {
        val language = getSharedPrefInstance().getStringValue(LANGUAGE, "es")
    ...
    override fun onResume() {
        super.onResume()
        val locale = Locale(PerFeetApp.language)
        val appTheme = PerFeetApp.appTheme
