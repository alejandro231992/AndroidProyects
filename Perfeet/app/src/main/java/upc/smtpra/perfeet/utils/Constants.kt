package upc.smtpra.perfeet.utils
...
object Constants {
    ...
    object Config {
        const  val DEFAULT_URL = "http://10.0.2.2/perfeet/"
        const  val BASE_URL= DEFAULT_URL+"wp-json/"
        //const val consumerKey = "ZH0mxMZ63h22"
        const val consumerKey = "EA5Tpj1pmy7r"
        //const val consumerSecret = "z5RTcjT0NseqCYbfTQXaSwSNC054HLp0SGGhqbMKlpWWtOTH"
        const val consumerSecret = "6b6W5ezuEozQN7FEiJOOLGz5X9kRsEPxftZu1k4RDaq3ir4w"
        //const val token = "gN3kZdeh2Yyh6Ntdvip4Mokf"
        const val token = "iedeYMndqXgyw5LAVTe1dt6I"
        //const val tokenSecret = "EhhwL3Ta6GSevnG6aKd4pCdp2X3rosIivzubXmZxSLkByi31"
        const val tokenSecret = "KVGXMbFEjpAWMVG34SqTxLwhkribNhVjdmAbhQOSnrbQfpq1"
