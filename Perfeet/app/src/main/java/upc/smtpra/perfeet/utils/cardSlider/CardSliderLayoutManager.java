package upc.smtpra.perfeet.utils.cardSlider;
...
public class CardSliderLayoutManager extends RecyclerView.LayoutManager
    ...
    private static final int DEFAULT_ACTIVE_CARD_LEFT_OFFSET = 12;
    ...
    public CardSliderLayoutManager(@NonNull Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final int defaultCardWidth = (int) (context.getResources().getDisplayMetrics().widthPixels- (28 * density));
