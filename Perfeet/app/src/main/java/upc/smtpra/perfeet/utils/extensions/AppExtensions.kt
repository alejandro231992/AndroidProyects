...
import upc.smtpra.perfeet.PerFeetApp.Companion.noInternetDialog
import upc.smtpra.perfeet.activity.DashBoardActivity
import upc.smtpra.perfeet.activity.ProductDetailActivity
import upc.smtpra.perfeet.models.*
import upc.smtpra.perfeet.utils.Constants
import upc.smtpra.perfeet.utils.Constants.AppBroadcasts.ADDRESS_UPDATE
import upc.smtpra.perfeet.utils.Constants.AppBroadcasts.CART_COUNT_CHANGE
import upc.smtpra.perfeet.utils.Constants.AppBroadcasts.ORDER_COUNT_CHANGE
import upc.smtpra.perfeet.utils.Constants.AppBroadcasts.PROFILE_UPDATE
import upc.smtpra.perfeet.utils.Constants.AppBroadcasts.WISHLIST_UPDATE
import upc.smtpra.perfeet.utils.Constants.KeyIntent.DATA
import upc.smtpra.perfeet.utils.Constants.PLAY_STORE_URL_PREFIX
import upc.smtpra.perfeet.utils.Constants.SharedPref.CART_DATA
import upc.smtpra.perfeet.utils.Constants.SharedPref.CATEGORY_DATA
import upc.smtpra.perfeet.utils.Constants.SharedPref.DEFAULT_CURRENCY
import upc.smtpra.perfeet.utils.Constants.SharedPref.IS_LOGGED_IN
import upc.smtpra.perfeet.utils.Constants.SharedPref.IS_SOCIAL_LOGIN
import upc.smtpra.perfeet.utils.Constants.SharedPref.KEY_ADDRESS
import upc.smtpra.perfeet.utils.Constants.SharedPref.KEY_CART_COUNT
import upc.smtpra.perfeet.utils.Constants.SharedPref.KEY_DASHBOARD
import upc.smtpra.perfeet.utils.Constants.SharedPref.KEY_ORDERS
import upc.smtpra.perfeet.utils.Constants.SharedPref.KEY_RECENTS
import upc.smtpra.perfeet.utils.Constants.SharedPref.KEY_USER_ADDRESS
import upc.smtpra.perfeet.utils.Constants.SharedPref.KEY_WISHLIST_COUNT
import upc.smtpra.perfeet.utils.Constants.SharedPref.SLIDER_IMAGES_DATA
import upc.smtpra.perfeet.utils.Constants.SharedPref.THEME_COLOR
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_DISPLAY_NAME
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_EMAIL
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_FIRST_NAME
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_ID
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_LAST_NAME
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_NICE_NAME
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_PROFILE
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_ROLE
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_TOKEN
import upc.smtpra.perfeet.utils.Constants.SharedPref.USER_USERNAME
import upc.smtpra.perfeet.utils.Constants.SharedPref.WISHLIST_DATA
...
fun getSharedPrefInstance(): SharedPrefUtils {
    return if (PerFeetApp.sharedPrefUtils == null) {
        PerFeetApp.sharedPrefUtils = SharedPrefUtils()
        PerFeetApp.sharedPrefUtils!!
    } else {
        PerFeetApp.sharedPrefUtils!!
    }
}
