...
import upc.smtpra.perfeet.utils.extensions.getApiToken
import upc.smtpra.perfeet.utils.extensions.getUserId
...
interface RestApis {
    ...
    fun forgetPassword(@Body request: RequestModel): Call<String>
